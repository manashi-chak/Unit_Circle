...
gen_imp={
    1:dict(
        genuine_count=14791,     #NDIRIS-0405 total genuine and imposter samples for testing
        imposter_count=5743130
    ),
    2:dict(
        genuine_count=4478,   #Casia-Interval total genuine and imposter samples for testing
        imposter_count=848993
    ),
    3:dict(
        genuine_count=2098,    #IIT-D total genuine and imposter samples for testing
